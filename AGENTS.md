...
| **Review pipeline program (R0–R8)** | [docs/review-pipeline/README.md](docs/review-pipeline/README.md) — R0–R7 on `main`; **R8** active ([execution](docs/review-pipeline/waves/REVIEW_PIPELINE_R8_EXECUTION.md)) |
