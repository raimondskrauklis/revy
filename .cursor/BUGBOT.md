...
**Program:** Review generation lifecycle on feature branch `feat/review-generation-lifecycle` — HEAD-gated publish, supersede in-flight generations, full surface flush, optional coalesce.
