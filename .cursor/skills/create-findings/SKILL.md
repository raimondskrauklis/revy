...
5. Bake in the KP principles: real data only / **no fallbacks/imputation**; **never mislead** (precise or N/A); full **lineage/transparency** (StepTracker); **no corner-cutting** (fix shared infra so all consumers benefit); reuse math, don't fork.
...
- **External research / patterns** *(optional)* — outside methods or prior art; explicit **adopt / defer / reject** for KP.
