...
| *(open next)* | Model run capture (post-#98/#99) | `chore/mrc-staging-dogfood-p2` | push 2 — P2 snapshot + P3 API validation pending |
...
|---------|--------|----------|
| Model run capture (post-#98/#99) | `chore/mrc-staging-dogfood-p2` | [MODEL_RUN_CAPTURE_STAGING_VALIDATION.md](../models/model-run-capture/MODEL_RUN_CAPTURE_STAGING_VALIDATION.md) |
...
| Model run capture | [MODEL_RUN_CAPTURE_STAGING_VALIDATION.md](../models/model-run-capture/MODEL_RUN_CAPTURE_STAGING_VALIDATION.md) — P0/P1 PASS (#97); P2/P3 code shipped (#98/#99); dogfood push 2 pending |
