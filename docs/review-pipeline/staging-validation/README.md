...
|---------|--------|----------|
| PR summary rollup (post-#85 deploy) | `chore/psr-staging-dogfood` | [PR_SUMMARY_ROLLUP_STAGING_VALIDATION.md](../pr-summary-rollup/PR_SUMMARY_ROLLUP_STAGING_VALIDATION.md) — deploy boundary `2026-08-08T14:45:07Z` |
