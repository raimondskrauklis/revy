...
| **VALIDATE** | "Is Greptile's fix actually correct?" | Closed proof — one claim to break | Mechanism traced; master confirms from thinking + answer |
...
|---------|------|-------------|
| **Hosted GitHub Bugbot** | Post-push on PR; Greptile-class signal on our repo | `.cursor/BUGBOT.md` on **`main`** — **appended** to Cursor default ([forum](https://forum.cursor.com/t/does-bugbot-md-override-cursor-s-default-base-prompt/150078)); team dashboard rules override repo; `@cursor remember` on PR |
