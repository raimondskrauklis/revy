...
| D0 | Pass 3 cohort widen | [D0](./FINDING_RESOLUTION_POST_WAVE_C_D0_EXECUTION.md) | [#71](https://github.com/raimondskrauklis/revy/pull/71) | **done** |
| D1 | FR-CS4 staging dogfood | [D1](./FINDING_RESOLUTION_POST_WAVE_C_D1_EXECUTION.md) · [findings](../FINDING_RESOLUTION_POST_WAVE_C_D1_FINDINGS.md) | — | **in progress** |
