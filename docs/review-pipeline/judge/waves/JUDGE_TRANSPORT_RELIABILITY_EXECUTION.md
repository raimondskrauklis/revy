...
| T3 — Staging gate | Smoke + metrics + validation memo + doc sync | [JUDGE_TRANSPORT_RELIABILITY_T3_EXECUTION.md](./JUDGE_TRANSPORT_RELIABILITY_T3_EXECUTION.md) | partial — staging human gate pending |
