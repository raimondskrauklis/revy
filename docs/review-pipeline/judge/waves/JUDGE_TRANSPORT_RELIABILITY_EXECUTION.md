...
| T3 — Staging gate | Smoke + metrics + validation memo + doc sync | [JUDGE_TRANSPORT_RELIABILITY_T3_EXECUTION.md](./JUDGE_TRANSPORT_RELIABILITY_T3_EXECUTION.md) | partial — T3.3 direct PASS ([#76](https://github.com/raimondskrauklis/revy/pull/76) `8120cc3`); gateway fallback + T3.1/T3.2 pending |
