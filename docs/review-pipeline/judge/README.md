...
| [JUDGE_STAGING_SPEND_INVESTIGATION_FINDINGS.md](./JUDGE_STAGING_SPEND_INVESTIGATION_FINDINGS.md) | Anthropic billing vs DB judge calls (2026-07-31 RR-W1 dogfood) |
