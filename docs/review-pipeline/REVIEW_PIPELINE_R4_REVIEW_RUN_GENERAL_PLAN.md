...
**Status:** Execution ready — [waves/REVIEW_PIPELINE_R4_EXECUTION.md](./waves/REVIEW_PIPELINE_R4_EXECUTION.md) peer-reviewed; implement on `feat/review-r4-review-run`.
