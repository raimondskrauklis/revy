...
| JTB-Q5 | Will retry recover thinking-only (8)? | **closed (not observed)** | Post-#103 window: `retry_count=0`; no thinking-only recoveries to measure. D9 94.3% ceiling stands — [validation memo](./JUDGE_THINKING_BLOCKS_STAGING_VALIDATION.md) |
