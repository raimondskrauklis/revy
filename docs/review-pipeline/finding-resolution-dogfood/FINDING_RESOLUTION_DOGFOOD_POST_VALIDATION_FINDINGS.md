...
| **DG-PV-Q2** | Is FR-DG2 staging-closed? | **locked** | **No** — partial; probe removal failed; follow Track A+B |
| **DG-PV-Q3** | Root cause of probe survival? | **locked** | RC-1 — deleted files not stamped `addressed` |
| **DG-PV-Q4** | Next code work? | **open** | Track A — file-deletion Pass 1 |
| **DG-PV-Q5** | Merge #65? | **open** | Safe for FR-DG1 + probe cleanup; **not** FR-DG2 sign-off |
| **DG-PV-Q6** | New gap ID for Track A? | **proposed** | **FR-DG2a** — file-deletion Pass 1 stamp (child of FR-DG2) |
