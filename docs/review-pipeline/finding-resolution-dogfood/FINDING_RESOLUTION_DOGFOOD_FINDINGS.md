...
| **FR-DG2** | Stale finding group survives code removal (block 2 + inline orphan) | high | [#67](https://github.com/raimondskrauklis/revy/pull/67) | **partial PASS** — [FR-CS1](../finding-resolution/FINDING_RESOLUTION_CLOSURE_SCOPE_FINDINGS.md#fr-cs1) wave C |
