...
|-------|--------|-----------|------|--------|
| P0 — Repro + observability | Probe, memo stub, metrics, SSOT | [P0](./FINDING_RESOLUTION_DOGFOOD_P0_EXECUTION.md) | A | pending |
| P1 — FR-DG1 | Manifest + G9 wiring | [P1](./FINDING_RESOLUTION_DOGFOOD_P1_EXECUTION.md) | A | pending |
| P2 — FR-DG2 | Stale retirement + collapse | [P2](./FINDING_RESOLUTION_DOGFOOD_P2_EXECUTION.md) | A | pending |
| P3 — Staging sign-off | Evidence + doc sync | [P3](./FINDING_RESOLUTION_DOGFOOD_P3_EXECUTION.md) | A | pending |
