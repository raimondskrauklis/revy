...
| Phase | File | Status |
|-------|------|--------|
| P0 — Foundations | Migration `0029`, SSOT, caps (settings only), path-exists CI | [waves/REVIEW_ENGINEERING_CONTEXT_P0_EXECUTION.md](./waves/REVIEW_ENGINEERING_CONTEXT_P0_EXECUTION.md) | pending |
