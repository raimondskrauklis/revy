...
| P6 — Publish surface | Greptile-depth issue comment + shape guard | [waves/REVIEW_ENGINEERING_CONTEXT_P6_EXECUTION.md](./waves/REVIEW_ENGINEERING_CONTEXT_P6_EXECUTION.md) | PR #61 |
| P7 — Operator visibility | `context_stats` API + `--rcx-gate` | [waves/REVIEW_ENGINEERING_CONTEXT_P7_EXECUTION.md](./waves/REVIEW_ENGINEERING_CONTEXT_P7_EXECUTION.md) | PR #61 |
