...
| **Snapshot generation at HEAD** | Greptile/Bugbot: latest pass only; supersede in-flight; results after finish | [review-generation-lifecycle](./review-generation-lifecycle/) — HEAD gate, supersede on sync (review + index), stage guards, coalesce ≤10 s, judge publish gate, deferred resolution pairing | **shipped** — [PR #54](https://github.com/raimondskrauklis/revy/pull/54) P0–P5; restart hotfix [PR #89](https://github.com/raimondskrauklis/revy/pull/89) |
