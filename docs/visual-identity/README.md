...
| P1 | Public landing + login split + voice | [VISUAL_IDENTITY_P1_EXECUTION.md](./VISUAL_IDENTITY_P1_EXECUTION.md) | pending |
| P2 | Shell, settings/admin, connect chrome | [VISUAL_IDENTITY_P2_EXECUTION.md](./VISUAL_IDENTITY_P2_EXECUTION.md) | pending |
