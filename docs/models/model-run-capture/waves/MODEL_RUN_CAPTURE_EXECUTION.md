...
|-------|--------|------|--------|
| MRC-P0 | Index manifest + step embedding identity | [P0](./MODEL_RUN_CAPTURE_P0_EXECUTION.md) | pending |
| MRC-P1 | Attempt rows + judge/publish step models | [P1](./MODEL_RUN_CAPTURE_P1_EXECUTION.md) | pending |
| MRC-P2 | `models_snapshot` + staging metrics by model | [P2](./MODEL_RUN_CAPTURE_P2_EXECUTION.md) | pending |
