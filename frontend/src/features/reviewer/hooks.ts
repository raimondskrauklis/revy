...
export const reviewerQueryKeys = {
  ...
  /** Invalidates all repository queries for a workspace, regardless of installation. */
  repositoriesAll: (workspaceId: string) =>
    ['reviewer', 'repositories', workspaceId] as const,
