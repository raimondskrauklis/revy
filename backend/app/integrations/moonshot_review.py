...
ISSUE_COMMENT_FORMAT_SYSTEM_PROMPT = (
    ...
    "(8) <details><summary>Security review</summary> when security findings exist; "
    "(9) <details><summary>Important files changed</summary> table (File | Note); "
    "(10) <details><summary>Review metadata</summary> with head_sha and revision. "
